function [outputFile] = processDataFileGluR2Internalization(logFileDict,theXLFile,sheetName)
% Function create a csv file with new columns populated based on the
% contents of a log file
%
% Notes: 1. this is correct assuming GLUR2 experiment only
...
elseif strfind(lower(sheetName),'well')
    ...
    error('processDataFileGLUR2: neither well nor field found in sheet name');
end
